"""
predict_rf.py — Inference script Random Forest Regressor
...
MODEL_PATH  = os.path.join(SCRIPT_DIR, '..', 'models', 'car_price_rf_model.sav')
...
try:
    ...
    fail(f"Gagal load model Random Forest: {e}")
